...
from .forms import PrestataireForm, ClientForm, FactureForm, PrestToFactForm
...
def facture_create(request):
    ...
    if request.method == "POST":
        ...
        formset = FactureFormSet(request.POST)
    ...
    print(formset)
    return render(request, template_name="facture/facture_form.html", context={
